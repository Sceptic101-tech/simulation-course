...
По результатам исследования можно сделать вывод - наиважнейшей переменой моделирования является **шаг модлеирования**. При высоком шаге моделирования производная получает очень слабую аппроксимацию, что, безусловно, сказывается на результатах моделирования (см график функции для dt = 0,1 и dt = 0,01).
